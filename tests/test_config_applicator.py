...
from si.apps.reverseproxy import installwizard
...
class TestDefaultSettings(twisted.trial.unittest.TestCase):
    ...
    def __init__(self, methodname, function_to_test=None):
        super(TestDefaultSettings, self).__init__(methodname)
    ...
    @patch("si.platform.filesystem.filewriter.HeadedFileWriter")
    @patch("si.platform.filesystem.filewriter.FileWriter")
    ...
    def test_simple_settings_applied(
        ...
        self._run_settings_applied_test()
...
class TestBaseNetworkSettings(TestDefaultSettings):
    ...
    def __init__(self, methodname):
        super(TestBaseNetworkSettings, self).__init__(
            methodname, "_apply_base_network_config"
        )
...
class TestNtpServerSettings(TestDefaultSettings):
    ...
    def __init__(self, methodname):
        super(TestNtpServerSettings, self).__init__(
            methodname, "_apply_ntp_server_config"
        )
...
class TestNginxServerSettings(TestDefaultSettings):
    ...
    def __init__(self, methodname):
        super(TestNginxServerSettings, self).__init__(
            methodname, "_apply_nginx_server_config"
        )
...
class TestIPTablesSettings(TestDefaultSettings):
    ...
    def __init__(self, methodname):
        super(TestIPTablesSettings, self).__init__(methodname, "_apply_iptables_config")
        self.rules = None
    ...
    def assertNotStandardRule(self, expected_rule):
        """
...
class TestTurnServerSettings(TestDefaultSettings):
    ...
    def __init__(self, methodname):
        super(TestTurnServerSettings, self).__init__(methodname, "_apply_turn_config")
