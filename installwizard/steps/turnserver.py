...
from si.apps.reverseproxy.steps.base_step import StepError, Step, MultiStep
...
"""
    ...
    def _get_turn_username(self, config):
        ...
        try:
            ...
            raise StepError("Username contains an invalid character")
    ...
    def _get_turn_password(self, config):
        ...
        try:
            ...
            raise StepError("Password contains an invalid character")
...
will be allowed to connect. A TURN secret key must also be used for authentication instead of a username+password
    ...
    def _get_turn_shared_secret(self, config):
        ...
        try:
            ...
            raise StepError("Shared secret contains an invalid character")
